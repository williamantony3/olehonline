          ...
          <div class="ps-section__header mb-50">
            <div class="row">
                  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="Makanan">- Makanan</h3>
                  </div>
          ...
          <div class="ps-section__content">
            ...
            @foreach($foods as $food)
              <div class="ps-shoes--carousel">
                <div class="ps-shoe">
                  <div class="ps-shoe__thumbnail"><img src="/assets/images/product/{{$food->ProductImage}}" alt=""><a class="ps-shoe__overlay" href="/product/detail/{{$food->ProductId}}"></a>
                  </div>
                  <div class="ps-shoe__content">
                    <div class="ps-shoe__variants">
                      <center><a href="/product/detail/{{$food->ProductId}}"><button class="ps-btn" style="font-size:14px; width:70%;">Lihat<i class="ps-icon-next"></i></button></a></center>
                    </div>
                    <div class="ps-shoe__detail">
                      <a class="ps-shoe__name" href="/product/detail/{{$food->ProductId}}">{{$food->ProductName}}</a>
                      <p class="ps-shoe__categories"><a href="/product/type/{{$food->ProductTypeId}}">{{$food->productType->ProductTypeName}}</a></p><span class="ps-shoe__price">
      ...
      <div class="ps-section ps-section--top-sales ps-owl-root pb-80">
        <div class="ps-container">
          <div class="ps-section__header mb-50">
            <div class="row">
                  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
                    <h3 class="ps-section__title" data-mask="Cinderamata">- Cinderamata</h3>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <div class="ps-owl-actions"><a class="ps-prev" href="#"><i class="ps-icon-arrow-right"></i></a><a class="ps-next" href="#"><i class="ps-icon-arrow-left"></i></a></div>
                  </div>
